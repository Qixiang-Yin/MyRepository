...
\begin{document}
	...
	\begin{equation}
		...
		物质中的混合角：
		\begin{gather}
			\sin2\theta_m=\frac{\sin2\theta}{\sqrt{\left(1\mp\dfrac{n_e}{n_{\mathrm{res}}}\right)^2\cos^22\theta+\sin^22\theta}}\\
			\cos2\theta_m=\frac{\left(1\mp\dfrac{n_e}{n_{\mathrm{res}}}\right)\cos2\theta}{\sqrt{\left(1\mp\dfrac{n_e}{n_{\mathrm{res}}}\right)^2\cos^22\theta+\sin^22\theta}}
		\end{gather}
		其中，我们引入了\textbf{共振密度}：
		\begin{equation}
		...
		我们首先考虑物质密度不变的情形，即$n_e(x)=n_e=\mathrm{const}$。
